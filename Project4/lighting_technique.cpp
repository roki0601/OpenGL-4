...
/*Ёто обновленный вершинный шейдер. «десь не так много нового, больша€ часть изменений в фрагментном шейдере.
  ƒобавилс€ тангент, который принимаетс€, трансформируетс€ в мировое пространство и идет на выход.*/
